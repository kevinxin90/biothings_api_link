...
AVAILABLE_API_SOURCES={"mygene.info": {
 	"annotate_ids": ["ensembl_gene_id", "hgnc_gene_id"],
 	"query_ids": ["uniprot_id", "ensembl_gene_id", "hgnc_gene_id", "wikipathway_id", "pubmed_id"],
  ...
  "lynx_pathway": {
    "query_ids": ["hgnc_gene_symbol", "hgnc_gene_id"],
    "query_syntax": "http://lynx.ci.uchicago.edu/gediresources/resources/genes/9606/*/pathways"
  },
  "lynx_diseases": {
    "query_ids": ["hgnc_gene_symbol", "hgnc_gene_id"],
    "query_syntax": "http://lynx.ci.uchicago.edu/gediresources/resources/genes/9606/*/diseases"
  },
  "lynx_interactions": {
    "query_ids": ["hgnc_gene_symbol", "hgnc_gene_id"],
    "query_syntax": "http://lynx.ci.uchicago.edu/gediresources/resources/genes/9606/*/interactions"
  },
  "lynx_symptoms": {
    "query_ids": ["hgnc_gene_symbol", "hgnc_gene_id"],
    "query_syntax": "http://lynx.ci.uchicago.edu/gediresources/resources/genes/9606/*/symptoms"
  },
  "lynx_brainconnectivity": {
    "query_ids": ["hgnc_gene_symbol", "hgnc_gene_id"],
    "query_syntax": "http://lynx.ci.uchicago.edu/gediresources/resources/genes/9606/*/brainconnectivity"
  },
  "genenames.org": {
  ...
  "expression_array": {
    "query_ids": ["pubmed_id"],
    "query_syntax": "https://www.ebi.ac.uk/arrayexpress/json/v3/experiments?pmid=*"
  }}
