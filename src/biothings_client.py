...
class ClientRedirect:
	...
	def get_id_list(self, api, query_info):
		'''
		return a list of ids related to the query info
		'''
		id_list = [_record['_id'] for _record in self.query(api, query_info, fields='_id')]
		print('Number of IDs from {} related to this query is : {}'.format(api, len(id_list)))
		return id_list
